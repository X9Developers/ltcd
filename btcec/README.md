...
* [Sign Message](https://pkg.go.dev/github.com/ltcsuite/ltcd/btcec/v2#example-package--SignMessage)  
  Demonstrates signing a message with a secp256k1 private key that is first
  parsed form raw bytes and serializing the generated signature.

* [Verify Signature](https://pkg.go.dev/github.com/ltcsuite/ltcd/btcec/v2#example-package--VerifySignature)  
